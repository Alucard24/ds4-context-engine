...
- `npm run latency:check -- <exact ds4-context-core@0.1.2>`: passed with ratio `0.939056`, at or below `1.10`.
- `npm run pack:check`: verified core (207 files), reference adapter (7 files), and Pi adapter (61 files) in a clean consumer.
...
Clean committed-candidate replay, tarball review, and exact registry verification are required before tag or GitHub prerelease creation.
